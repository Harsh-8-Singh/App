...
public class DB extends SQLiteOpenHelper {
    ...
    public String loginsByName(String loginName){
        String res="";
        SQLiteDatabase db = this.getReadableDatabase();
        String sql = "select * from "+TABLE_LOGIN_NAME+" WHERE "+COL_LOGIN_USERNAME+" = '"+loginName+"'";
        Cursor resu = db.rawQuery(sql,null);
        if (resu.moveToNext()) {
            res="Data Found \n Username: "+resu.getString(1)+"\nPassword: "+resu.getString(2);
            return res;
        }
        return "Not Found";
    }
    ...
    public String noteByName(String noteName){
        String res="";
        SQLiteDatabase db = this.getReadableDatabase();
        String sql = "select * from "+TABLE_NOTE_NAME+" WHERE "+COL_NOTE_NAME+" = '"+noteName+"'";
        Cursor resul = db.rawQuery(sql,null);
        if (resul.moveToNext()) {
            res="Data Found \n Note Name: "+resul.getString(1)+"\n Note Text: "+resul.getString(2);
            return res;
        }
