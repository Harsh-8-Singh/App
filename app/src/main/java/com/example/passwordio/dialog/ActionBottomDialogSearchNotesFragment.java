...
public class ActionBottomDialogSearchNotesFragment extends BottomSheetDialogFragment implements View.OnClickListener{
    ...
    private TextView s;
    private DB db;
    public static ActionBottomDialogSearchNotesFragment newInstance() {
        return new ActionBottomDialogSearchNotesFragment();
    }
    ...
    private void handleSave() {
       ...
       String res = db.noteByName(uname);
        s.setText(res);
    }
