...
public class LoginItemsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.actionBarSearch:
                ActionBottomDialogSearchFragment dialog = ActionBottomDialogSearchFragment.newInstance();
